...
const WorkingImageUpload = ({ value, onChange, className = "" }) => {
  ...
  const handleFileSelect = async (event) => {
    ...
    try {
      ...
      // Create FormData - using the existing "active" preset
      const formData = new FormData();
      formData.append('file', file);
      formData.append('upload_preset', 'active'); // Use the existing preset
